...
namespace RadarIO.iOSBinding
{
	...
	interface RadarTimeZone
	{
		...
		// @property (readonly, copy, nonatomic) NSDate * _Nonnull currentTime;
		[Export("currentTime", ArgumentSemantic.Copy)]
		NSDate CurrentTime { get; }

		// @property (readonly, assign, nonatomic) int utcOffset;
		[Export("utcOffset")]
		int UtcOffset { get; }

		// @property (readonly, assign, nonatomic) int dstOffset;
		[Export("dstOffset")]
		int DstOffset { get; }
	...
	interface RadarAddress
	{
		...
		// @property (readonly, copy, nonatomic) NSNumber * _Nullable distance;
		[NullAllowed, Export("distance", ArgumentSemantic.Copy)]
		...
		// @property (readonly, copy, nonatomic) RadarTimeZone * _Nullable timeZone;
		[NullAllowed, Export("timeZone", ArgumentSemantic.Copy)]
		RadarTimeZone TimeZone { get; }
	...
	{
		// @property (readonly, nonatomic, strong) NSDictionary<NSString *,NSArray<NSArray<NSString *> *> *> * hours;
		[Export("hours", ArgumentSemantic.Strong)]
		NSDictionary<NSString, NSArray<NSArray<NSString>>> Hours { get; }
	}
	...
	interface RadarGeofence
	{
		...
		// @property (readonly, copy, nonatomic) RadarOperatingHours * _Nullable operatingHours;
		[NullAllowed, Export("operatingHours", ArgumentSemantic.Copy)]
		RadarOperatingHours OperatingHours { get; }
	...
	interface RadarPlace
	{
		...
		// @property (readonly, nonatomic, strong) RadarAddress * _Nullable address;
		[NullAllowed, Export("address", ArgumentSemantic.Strong)]
		RadarAddress Address { get; }
	...
	interface RadarRegion
	{
		...
		// @property (readonly, assign, nonatomic) BOOL expected;
		[Export("expected")]
		bool Expected { get; }
	...
	interface RadarFraud
	{
		...
		// @property (readonly, assign, nonatomic) _Bool sharing;
		[Export("sharing")]
		bool Sharing { get; }

		// @property (readonly, assign, nonatomic) _Bool blocked;
		[Export("blocked")]
		bool Blocked { get; }
	...
	interface RadarUser
	{
		...
		// @property (readonly, assign, nonatomic) RadarActivityType activityType;
		[Export("activityType", ArgumentSemantic.Assign)]
		RadarActivityType ActivityType { get; }
	...
	{
		// @property (readonly, nonatomic, strong) RadarUser * _Nullable user;
		[NullAllowed, Export("user", ArgumentSemantic.Strong)]
		RadarUser User { get; }

		// @property (readonly, nonatomic, strong) NSArray<RadarEvent *> * _Nullable events;
		[NullAllowed, Export("events", ArgumentSemantic.Strong)]
		RadarEvent[] Events { get; }

		// @property (readonly, copy, nonatomic) NSString * _Nullable token;
		[NullAllowed, Export("token")]
		string Token { get; }

		// @property (readonly, copy, nonatomic) NSDate * _Nullable expiresAt;
		[NullAllowed, Export("expiresAt", ArgumentSemantic.Copy)]
		NSDate ExpiresAt { get; }

		// @property (readonly, assign, nonatomic) NSTimeInterval expiresIn;
		[Export("expiresIn")]
		...
		// @property (readonly, copy, nonatomic) NSArray<NSString *> * _Nullable failureReasons;
		[NullAllowed, Export("failureReasons", ArgumentSemantic.Copy)]
		string[] FailureReasons { get; }

		// @property (readonly, copy, nonatomic) NSString * _Nullable _id;
		[NullAllowed, Export("_id")]
		string _id { get; }

		// @property (readonly, copy, nonatomic) NSDictionary * _Nullable fullDict;
		[NullAllowed, Export("fullDict", ArgumentSemantic.Copy)]
		NSDictionary FullDict { get; }
	...
	[BaseType(typeof(NSObject))]
	interface RadarInitializeOptions
	{
		// @property (assign, nonatomic) BOOL autoLogNotificationConversions;
		[Export("autoLogNotificationConversions")]
		bool AutoLogNotificationConversions { get; set; }

		// @property (assign, nonatomic) BOOL autoHandleNotificationDeepLinks;
		[Export("autoHandleNotificationDeepLinks")]
		bool AutoHandleNotificationDeepLinks { get; set; }
		...
		[Export("initWithDict:")]
		NativeHandle Constructor([NullAllowed] NSDictionary dict);
	}
	...
	// typedef void (^ _Nullable)(RadarStatus, RadarVerifiedLocationToken * _Nullable) RadarTrackVerifiedCompletionHandler;
	delegate void RadarTrackVerifiedCompletionHandler(RadarStatus arg0, [NullAllowed] RadarVerifiedLocationToken arg1);
	...
	// typedef void (^ _Nullable)(RadarStatus, RadarEvent * _Nullable) RadarLogConversionCompletionHandler;
	...
	interface Radar
	{
		...
		// +(void)initializeWithPublishableKey:(NSString * _Nonnull)publishableKey options:(RadarInitializeOptions * _Nullable)options __attribute__((swift_name("initialize(publishableKey:options:)")));
		[Static]
		[Export("initializeWithPublishableKey:options:")]
		void InitializeWithPublishableKey(string publishableKey, [NullAllowed] RadarInitializeOptions options);
		...
		[Static]
		[Export("setProduct:")]
		void SetProduct([NullAllowed] string product);

		// +(NSString * _Nullable)getProduct;
		[Static]
		[NullAllowed, Export("getProduct")]
		...
		// +(void)trackVerifiedWithCompletionHandler:(RadarTrackVerifiedCompletionHandler _Nullable)completionHandler __attribute__((swift_name("trackVerified(completionHandler:)")));
		[Static]
		[Export("trackVerifiedWithCompletionHandler:")]
		void TrackVerifiedWithCompletionHandler([NullAllowed] RadarTrackVerifiedCompletionHandler completionHandler);

		// +(void)trackVerifiedWithBeacons:(BOOL)beacons desiredAccuracy:(RadarTrackingOptionsDesiredAccuracy)desiredAccuracy completionHandler:(RadarTrackVerifiedCompletionHandler _Nullable)completionHandler __attribute__((swift_name("trackVerified(beacons:desiredAccuracy:completionHandler:)")));
		[Static]
		[Export("trackVerifiedWithBeacons:desiredAccuracy:completionHandler:")]
		void TrackVerifiedWithBeacons(bool beacons, RadarTrackingOptionsDesiredAccuracy desiredAccuracy, [NullAllowed] RadarTrackVerifiedCompletionHandler completionHandler);
		...
		[Static]
		[Export("trackVerifiedWithBeacons:desiredAccuracy:reason:transactionId:completionHandler:")]
		void TrackVerifiedWithBeacons(bool beacons, RadarTrackingOptionsDesiredAccuracy desiredAccuracy, [NullAllowed] string reason, [NullAllowed] string transactionId, [NullAllowed] RadarTrackVerifiedCompletionHandler completionHandler);

		// +(void)startTrackingVerifiedWithInterval:(NSTimeInterval)interval beacons:(BOOL)beacons __attribute__((swift_name("startTrackingVerified(interval:beacons:)")));
		[Static]
		[Export("startTrackingVerifiedWithInterval:beacons:")]
		void StartTrackingVerifiedWithInterval(double interval, bool beacons);

		// +(void)stopTrackingVerified __attribute__((swift_name("stopTrackingVerified()")));
		[Static]
		...
		[Static]
		[Export("isTrackingVerified")]

		bool IsTrackingVerified { get; }

		// +(void)getVerifiedLocationToken:(RadarTrackVerifiedCompletionHandler _Nullable)completionHandler __attribute__((swift_name("getVerifiedLocationToken(completionHandler:)")));
		[Static]
		[Export("getVerifiedLocationToken:")]
		void GetVerifiedLocationToken([NullAllowed] RadarTrackVerifiedCompletionHandler completionHandler);

		// +(void)getVerifiedLocationTokenWithBeacons:(BOOL)beacons desiredAccuracy:(RadarTrackingOptionsDesiredAccuracy)desiredAccuracy completionHandler:(RadarTrackVerifiedCompletionHandler _Nullable)completionHandler __attribute__((swift_name("getVerifiedLocationToken(beacons:desiredAccuracy:completionHandler:)")));
		[Static]
		[Export("getVerifiedLocationTokenWithBeacons:desiredAccuracy:completionHandler:")]
		void GetVerifiedLocationTokenWithBeacons(bool beacons, RadarTrackingOptionsDesiredAccuracy desiredAccuracy, [NullAllowed] RadarTrackVerifiedCompletionHandler completionHandler);

		// +(void)clearVerifiedLocationToken;
		[Static]
		[Export("clearVerifiedLocationToken")]
		void ClearVerifiedLocationToken();

		// +(void)setExpectedJurisdictionWithCountryCode:(NSString * _Nullable)countryCode stateCode:(NSString * _Nullable)stateCode __attribute__((swift_name("setExpectedJurisdiction(countryCode:stateCode:)")));
		[Static]
		[Export("setExpectedJurisdictionWithCountryCode:stateCode:")]
		void SetExpectedJurisdictionWithCountryCode([NullAllowed] string countryCode, [NullAllowed] string stateCode);
		...
		void LogConversionWithName(string name, [NullAllowed] NSDictionary metadata, [NullAllowed] RadarLogConversionCompletionHandler completionHandler);
		...
		void LogConversionWithName(string name, NSNumber revenue, [NullAllowed] NSDictionary metadata, [NullAllowed] RadarLogConversionCompletionHandler completionHandler);
		...
		// +(void)logConversionWithNotificationResponse:(UNNotificationResponse * _Nonnull)response __attribute__((swift_name("logConversion(response:)")));
		[Static]
		[Export("logConversionWithNotificationResponse:")]
		...
		// +(void)searchPlacesWithRadius:(int)radius chains:(NSArray<NSString *> * _Nullable)chains categories:(NSArray<NSString *> * _Nullable)categories groups:(NSArray<NSString *> * _Nullable)groups countryCodes:(NSArray<NSString *> * _Nullable)countryCodes limit:(int)limit completionHandler:(RadarSearchPlacesCompletionHandler)completionHandler __attribute__((swift_name("searchPlaces(radius:chains:categories:groups:countryCodes:limit:completionHandler:)")));
		[Static]
		[Export("searchPlacesWithRadius:chains:categories:groups:countryCodes:limit:completionHandler:")]
		void SearchPlacesWithRadius(int radius, [NullAllowed] string[] chains, [NullAllowed] string[] categories, [NullAllowed] string[] groups, [NullAllowed] string[] countryCodes, int limit, RadarSearchPlacesCompletionHandler completionHandler);

		// +(void)searchPlacesWithRadius:(int)radius chains:(NSArray<NSString *> * _Nullable)chains chainMetadata:(NSDictionary<NSString *,NSString *> * _Nullable)chainMetadata categories:(NSArray<NSString *> * _Nullable)categories groups:(NSArray<NSString *> * _Nullable)groups countryCodes:(NSArray<NSString *> * _Nullable)countryCodes limit:(int)limit completionHandler:(RadarSearchPlacesCompletionHandler)completionHandler __attribute__((swift_name("searchPlaces(radius:chains:chainMetadata:categories:groups:countryCodes:limit:completionHandler:)")));
		[Static]
		[Export("searchPlacesWithRadius:chains:chainMetadata:categories:groups:countryCodes:limit:completionHandler:")]
		void SearchPlacesWithRadius(int radius, [NullAllowed] string[] chains, [NullAllowed] NSDictionary<NSString, NSString> chainMetadata, [NullAllowed] string[] categories, [NullAllowed] string[] groups, [NullAllowed] string[] countryCodes, int limit, RadarSearchPlacesCompletionHandler completionHandler);

		// +(void)searchPlacesNear:(CLLocation * _Nonnull)near radius:(int)radius chains:(NSArray<NSString *> * _Nullable)chains categories:(NSArray<NSString *> * _Nullable)categories groups:(NSArray<NSString *> * _Nullable)groups countryCodes:(NSArray<NSString *> * _Nullable)countryCodes limit:(int)limit completionHandler:(RadarSearchPlacesCompletionHandler)completionHandler __attribute__((swift_name("searchPlaces(near:radius:chains:categories:groups:countryCodes:limit:completionHandler:)")));
		[Static]
		[Export("searchPlacesNear:radius:chains:categories:groups:countryCodes:limit:completionHandler:")]
		void SearchPlacesNear(CLLocation near, int radius, [NullAllowed] string[] chains, [NullAllowed] string[] categories, [NullAllowed] string[] groups, [NullAllowed] string[] countryCodes, int limit, RadarSearchPlacesCompletionHandler completionHandler);
		...
		[Static]
		[Export("searchPlacesNear:radius:chains:chainMetadata:categories:groups:countryCodes:limit:completionHandler:")]
		void SearchPlacesNear(CLLocation near, int radius, [NullAllowed] string[] chains, [NullAllowed] NSDictionary<NSString, NSString> chainMetadata, [NullAllowed] string[] categories, [NullAllowed] string[] groups, [NullAllowed] string[] countryCodes, int limit, RadarSearchPlacesCompletionHandler completionHandler);

		// +(void)searchGeofences:(RadarSearchGeofencesCompletionHandler)completionHandler __attribute__((swift_name("searchGeofences(completionHandler:)")));
		[Static]
		[Export("searchGeofences:")]
		void SearchGeofences(RadarSearchGeofencesCompletionHandler completionHandler);

		// +(void)searchGeofencesNear:(CLLocation * _Nullable)near radius:(int)radius tags:(NSArray<NSString *> * _Nullable)tags metadata:(NSDictionary * _Nullable)metadata limit:(int)limit includeGeometry:(BOOL)includeGeometry completionHandler:(RadarSearchGeofencesCompletionHandler)completionHandler __attribute__((swift_name("searchGeofences(near:radius:tags:metadata:limit:includeGeometry:completionHandler:)")));
		[Static]
		[Export("searchGeofencesNear:radius:tags:metadata:limit:includeGeometry:completionHandler:")]
		void SearchGeofencesNear([NullAllowed] CLLocation near, int radius, [NullAllowed] string[] tags, [NullAllowed] NSDictionary metadata, int limit, bool includeGeometry, RadarSearchGeofencesCompletionHandler completionHandler);
		...
		// +(void)geocodeAddress:(NSString * _Nonnull)query layers:(NSArray<NSString *> * _Nullable)layers countries:(NSArray<NSString *> * _Nullable)countries completionHandler:(RadarGeocodeCompletionHandler)completionHandler __attribute__((swift_name("geocode(address:layers:countries:completionHandler:)")));
		[Static]
		[Export("geocodeAddress:layers:countries:completionHandler:")]
		void GeocodeAddress(string query, [NullAllowed] string[] layers, [NullAllowed] string[] countries, RadarGeocodeCompletionHandler completionHandler);
		...
		// +(void)reverseGeocodeWithLayers:(NSArray<NSString *> * _Nullable)layers completionHandler:(RadarGeocodeCompletionHandler)completionHandler __attribute__((swift_name("reverseGeocode(layers:completionHandler:)")));
		[Static]
		[Export("reverseGeocodeWithLayers:completionHandler:")]
		void ReverseGeocodeWithLayers([NullAllowed] string[] layers, RadarGeocodeCompletionHandler completionHandler);
		...
		// +(void)reverseGeocodeLocation:(CLLocation * _Nonnull)location layers:(NSArray<NSString *> * _Nullable)layers completionHandler:(RadarGeocodeCompletionHandler)completionHandler __attribute__((swift_name("reverseGeocode(location:layers:completionHandler:)")));
		[Static]
		[Export("reverseGeocodeLocation:layers:completionHandler:")]
		void ReverseGeocodeLocation(CLLocation location, [NullAllowed] string[] layers, RadarGeocodeCompletionHandler completionHandler);
		...
		// +(NSString * _Nonnull)stringForActivityType:(RadarActivityType)type __attribute__((swift_name("stringForActivityType(_:)")));
		[Static]
		[Export("stringForActivityType:")]
		...
		// +(void)nativeSetup:(RadarInitializeOptions * _Nonnull)options __attribute__((swift_name("nativeSetup(_:)")));
		[Static]
		[Export("nativeSetup:")]
		void NativeSetup(RadarInitializeOptions options);

		// +(void)openURLFromNotification:(UNNotification * _Nonnull)notification __attribute__((swift_name("openURLFromNotification(_:)")));
		[Static]
		[Export("openURLFromNotification:")]
	...
	interface RadarTripOptions
	{
		...
		NativeHandle Constructor(string externalId, [NullAllowed] string destinationGeofenceTag, [NullAllowed] string destinationGeofenceExternalId);
		...
		NativeHandle Constructor(string externalId, [NullAllowed] string destinationGeofenceTag, [NullAllowed] string destinationGeofenceExternalId, [NullAllowed] NSDate scheduledArrivalAt);

		// -(instancetype _Nonnull)initWithExternalId:(NSString * _Nonnull)externalId destinationGeofenceTag:(NSString * _Nullable)destinationGeofenceTag destinationGeofenceExternalId:(NSString * _Nullable)destinationGeofenceExternalId scheduledArrivalAt:(NSDate * _Nullable)scheduledArrivalAt startTracking:(BOOL)startTracking;
		[Export("initWithExternalId:destinationGeofenceTag:destinationGeofenceExternalId:scheduledArrivalAt:startTracking:")]
		NativeHandle Constructor(string externalId, [NullAllowed] string destinationGeofenceTag, [NullAllowed] string destinationGeofenceExternalId, [NullAllowed] NSDate scheduledArrivalAt, bool startTracking);
		...
		// @property (assign, nonatomic) BOOL startTracking;
		[Export("startTracking")]
		bool StartTracking { get; set; }
	...
	{
		// @required -(void)didUpdateToken:(RadarVerifiedLocationToken * _Nonnull)token __attribute__((swift_name("didUpdateToken(_:)")));
		[Abstract]
...
*/
	[Protocol]
	[BaseType(typeof(NSObject))]
	interface RadarMotionProtocol
	{
		// @required -(void)startActivityUpdatesToQueue:(NSOperationQueue * _Nonnull)queue withHandler:(CMMotionActivityHandler _Nonnull)handler;
		[Abstract]
		[Export("startActivityUpdatesToQueue:withHandler:")]
		void StartActivityUpdatesToQueue(NSOperationQueue queue, CMMotionActivityHandler handler);

		// @required -(void)stopActivityUpdates;
		[Abstract]
